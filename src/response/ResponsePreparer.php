...
class ResponsePreparer implements ResponsePreparerInterface
{
  ...
  public function validateAndPrepare($response, Request $request, $type, HttpKernelInterface $httpKernel)
  {
	...
	$event = new GetResponseForControllerResultEvent($httpKernel, $request, $type, $response);
    ...
    return $this->prepare($response, $request, $type, $httpKernel);
  }
  
  public function prepare(Response $response, Request $request, $type, HttpKernelInterface $httpKernel)
  {
      $event = new FilterResponseEvent($httpKernel, $request, $type, $response);
